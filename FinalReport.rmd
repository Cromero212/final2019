...
Question #1: Does abacavirinol have any affect on whether one contracts AIDS or not?
...
Question #2:does abacavirinol have a different affect based on gender?

$H_0:$ Gender has no effect on whether abacavirinol offers any protection agains contracting AIDS.

Question #3:does abacavirinol have a different affect based on drug use?

$H_0:$ Drug use has no effect on whether abacavirinol offers any protection agains contracting AIDS.

Question #4:does abacavirinol have a different affect based on sexual orientation?
...
The barchart shows that people that received the vaccine are less likely to contract AIDS.
...
This table shows that people who receive the vaccine are slightly less likely to contract AIDS.
...
From the bar chart, chi-squared test, and numberic table the results appear to demonstrate that vaccine use results in no measurable difference in infection rates after receiving the vaccine among males vs. females.
...
We use a bar chart to show the effectiveness of the vaccine on the general population while allowing for Sexual Orientation.
...
The vaccine looks like it is somewhat effective on the general population.  gender or Sexual orientation show no diffrence. The testing indicates that we reject the null hypotheses and accept that the vaccine appears to have some positive effect, which is slightly less for some subgroups including IV drug users. 